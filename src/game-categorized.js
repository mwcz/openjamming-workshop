...
3           layer = map.createLayer('platforms');

10          //  Un-comment this to see the collision tiles
10          // layer.debug = true;
...
1       function update() {
10          game.physics.arcade.collide(player, layer, null, () => !player.data.dying);
10          game.physics.arcade.collide(enemies, layer);
